...
const HomeClient = dynamic(() => import("@/components/home-client"), {
  ssr: false,
  loading: () => <p className="text-sm text-slate-500">Loading tools...</p>,
});

export default function HomePage() {
  return (
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-600 p-8 text-white shadow-lg">
